...
class _PocketCardDetailScreenState extends State<PocketCardDetailScreen> {
  ...
  String get _lowUrl =>
      widget.card.imageUrlLow ??
      '$kTcgDexAssets/tcgp/${widget.setId}/${widget.card.localId}/low.webp';

  String get _highUrl => _lowUrl.replaceAll('/low.webp', '/high.webp');
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Builder(builder: (_) {
                    final packs = _detail?.boosters.isNotEmpty == true
                        ? _detail!.boosters
                        : widget.card.boosters;
