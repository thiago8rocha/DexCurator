...
const _upBg     = Color(0x142E7D32);
const _upBorder = Color(0x592E7D32);
...
const _statLabel = {
  ...
  'spa': 'Ataque Especial',   'spd': 'Defesa Especial',
  'spe': 'Velocidade',
};
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            icon: Icon(
              Icons.filter_list,
              color: _filterStat != null ? scheme.primary : null,
            ),
            onPressed: _showStatFilter,
          ),
          // Botão de busca
          IconButton(
    ...
    return Padding(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (!n.isNeutral && n.likeFlavor != null) ...[
          ...
          Row(children: [
            const Text('Gosta: ', style: TextStyle(fontSize: 10, color: Color(0xFF888888))),
            const SizedBox(width: 2),
            Text(_flavorLabel[n.likeFlavor]!, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w500)),
            const SizedBox(width: 12),
            const Text('Odeia: ', style: TextStyle(fontSize: 10, color: Color(0xFF888888))),
            const SizedBox(width: 2),
